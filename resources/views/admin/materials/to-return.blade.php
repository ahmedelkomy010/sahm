        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card shadow-lg border-0 mb-4">
                    <div class="card-header text-white py-4" style="background: linear-gradient(135deg, #fdcb6e 0%, #e17055 100%);">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-1">
                                    <i class="fas fa-undo me-2"></i>
                                    المواد المطلوب إرجاعها - {{ $city }}
                                </h3>
                                <p class="mb-0 opacity-90">
                                    <i class="fas fa-box-open me-1"></i>
                                    المواد الزائدة التي يجب إعادتها إلى المستودع
                                </p>
                            </div>
                            <div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border-0 h-100" style="background: linear-gradient(135deg, #fdcb6e 0%, #e17055 100%);">
                            <div class="card-body text-white text-center py-3">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.materials.to-return.' . $project) }}">
                            <div class="row g-3">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{ route('admin.materials.to-return.' . $project) }}" class="btn btn-secondary">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-warning">{{ $order->workOrderMaterials->count() }}</span>
                                        </td>
                                        <td class="text-center">
