        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card shadow-lg border-0 mb-4">
                    <div class="card-header text-white py-4" style="background: linear-gradient(135deg, #6c5ce7 0%, #a29bfe 100%);">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-1">
                                    <i class="fas fa-balance-scale me-2"></i>
                                    الفرق بين المواد المنفذة والمصروفة - {{ $city }}
                                </h3>
                                <p class="mb-0 opacity-90">
                                    <i class="fas fa-chart-line me-1"></i>
                                    مقارنة بين الكميات المنفذة والكميات المصروفة من المستودع
                                </p>
                            </div>
                            <div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border-0 h-100" style="background: linear-gradient(135deg, #6c5ce7 0%, #a29bfe 100%);">
                            <div class="card-body text-white text-center py-3">
                                <i class="fas fa-cubes fa-2x mb-2 opacity-75"></i>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.materials.executed-disbursed.' . $project) }}">
                            <div class="row g-3">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{ route('admin.materials.executed-disbursed.' . $project) }}" class="btn btn-secondary">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-primary">{{ $order->workOrderMaterials->count() }}</span>
                                        </td>
                                        <td class="text-center">
