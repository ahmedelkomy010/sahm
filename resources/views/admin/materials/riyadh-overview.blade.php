        ...
        <div class="row align-items-center">
            <div class="col-12">
                ...
                <div class="d-flex gap-2 justify-content-center">
                    <a href="{{ route('admin.materials.attachments.index', ['project' => $project ?? 'riyadh']) }}" class="btn btn-warning btn-lg">
                        <i class="fas fa-paperclip me-2"></i>
                        مرفقات المواد
                    </a>
                    <a href="{{ route('admin.work-orders.index', ['project' => $project ?? 'riyadh']) }}" class="btn btn-success btn-lg">
