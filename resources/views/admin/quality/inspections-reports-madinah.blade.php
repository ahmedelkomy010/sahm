    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.quality.inspections-reports.madinah') }}" class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-6 d-flex align-items-end gap-2">
                            ...
                            <a href="{{ route('admin.quality.inspections-reports.madinah') }}" class="btn btn-secondary">
                                <i class="fas fa-redo me-1"></i>
                                إعادة تعيين
                            </a>
                            <a href="{{ route('admin.quality.inspections-reports.export', ['project' => 'madinah']) }}?{{ http_build_query(request()->except(['page'])) }}" 
