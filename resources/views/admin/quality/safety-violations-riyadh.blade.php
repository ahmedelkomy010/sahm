                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="mb-1">
                                ...
                                مخالفات السلامة (الرياض)
                            </h3>
                            <p class="mb-0 opacity-90">
                                <i class="fas fa-city me-1"></i>
                                عرض جميع مخالفات السلامة لأوامر العمل في مشروع الرياض
                            </p>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.quality.violations.riyadh') }}" class="btn btn-danger btn-sm">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.quality.safety-violations.export', ['city' => 'riyadh']) }}" class="btn btn-success btn-sm">
