    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #e91e63 0%, #f06292 100%);">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="mb-1">
                                <i class="fas fa-file-invoice-dollar me-2"></i>
                                إعداد مستخلص الدفعة الجزئية الأولى وجاري الصرف (المدينة المنورة)
                            </h3>
                            <p class="mb-0 opacity-90">
                                <i class="fas fa-mosque me-1"></i>
                                عرض جميع أوامر العمل بالمدينة المنورة التي حالتها: إعداد مستخلص الدفعة الجزئية الأولى وجاري الصرف
                            </p>
                        </div>
                        <div>
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="card shadow-sm border-0" style="background: linear-gradient(135deg, #e91e63 0%, #f06292 100%);">
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.work-orders.status.firstextract.madinah') }}" class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{ route('admin.work-orders.status.export-firstextract', ['project' => 'madinah']) }}" 
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-light">
                    <h5 class="mb-0">
                        <i class="fas fa-list me-2 text-pink"></i>
                        قائمة أوامر العمل
                    </h5>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge" style="background-color: #e91e63;">
                                            <i class="fas fa-file-invoice-dollar me-1"></i>
                                            إعداد مستخلص الدفعة الجزئية الأولى وجاري الصرف
                                        </span>
                                    </td>
                                    <td class="text-center">
                    ...
                    <div class="alert alert-info text-center">
                        ...
                        <p class="mb-0">لا توجد أوامر عمل بحالة "إعداد مستخلص الدفعة الجزئية الأولى وجاري الصرف" في المدينة المنورة حالياً</p>
                    </div>
                    @endif
                </div>
            </div>
