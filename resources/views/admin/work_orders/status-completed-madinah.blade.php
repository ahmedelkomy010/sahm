                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="mb-1">
                                ...
                                منتهي تم الصرف (المدينة المنورة)
                            </h3>
                            <p class="mb-0 opacity-90">
                                <i class="fas fa-mosque me-1"></i>
                                عرض جميع أوامر العمل بالمدينة المنورة التي حالتها: منتهي تم الصرف
                            </p>
                        </div>
                        <div>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info text-center">
                        ...
                        <p class="mb-0">لا توجد أوامر عمل بحالة "منتهي تم الصرف" في المدينة المنورة حالياً</p>
                    </div>
                    @endif
                </div>
            </div>
