                            ...
                            <div class="mb-4">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-sm align-middle">
                                        ...
                                        <tbody>
                                        @foreach([ '23232331 كابل منخفض00821918', '2 كابل منخفض0938376353', '3 كابل منخفض9378728783', '4 كابل منخفض23232323', '1 كابل متوسط2323232', '2 كابل متوسط232323', '3 كابل متوسط232323', '4 كابل متوسط'] as $cable)
                                        <tr>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-sm align-middle">
                                        ...
                                        <tbody>
                                        @foreach([ '12223243 كابل منخفض435345', '2 كابل منخفض345435', '3 كابل منخفض435435', '4 كابل منخفض435345', '1 كابل متوسط345 43545', '2 كابل متوسط 435345435', '3 كابل متوسط435345345', '4 كابل متوسط'] as $cable)
                                        <tr>
                                                <td class="align-middle">{{ $cable }}</td>
                                                <td colspan="4">
                                                    <div class="input-group input-group-sm">
                            ...
                            <div class="subsection mb-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-sm">
                                        ...
                                        <tbody>
                                        @foreach([ '121212كابل منخفض', '2 كابل منخفض', '3 كابل منخفض', '4 كابل منخفض', '1 كابل متوسط', '2 كابل متوسط', '3 كابل متوسط21121   ', '4 كابل متوسط'] as $cable)
                                        <tr>
                                                <td class="align-middle">{{ $cable }}</td>
                                                <td colspan="4">
                                                    <div class="input-group input-group-sm">
