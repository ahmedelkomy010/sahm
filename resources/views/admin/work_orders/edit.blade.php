            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-primary text-white py-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.work-orders.index') }}" class="btn btn-outline-light">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="form-section mb-4">
                                    <h4 class="section-title mb-3">معلومات الطلب الأساسية</h4>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <input id="work_type_number" type="number" min="1" max="999" class="form-control mb-2" placeholder="أدخل رقم نوع العمل" value="{{ $workOrder->work_type }}">
                                            </div>
                                            <div class="col-md-8">
                                                <select id="work_type" class="form-select @error('work_type') is-invalid @enderror" name="work_type">
                                                    ...
                                                    <option value="401" {{ old('work_type', $workOrder->work_type) == '401' ? 'selected' : '' }}> -  مخططات منح  وزارة  البلدية </option>
                                ...
                                <div class="form-section mb-4">
                                    <h4 class="section-title mb-3">معلومات المشترك</h4>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select id="office" class="form-select @error('office') is-invalid @enderror" name="office">
                                            ...
                                            <option value="الرياض" {{ old('office', $workOrder->office) == 'الشرق' ? 'selected' : '' }}>الشرق</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-section mb-4">
                                    <h4 class="section-title mb-3">معلومات القيمة والتنفيذ</h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="partial_deletion" name="partial_deletion" value="1" {{ old('partial_deletion', $workOrder->partial_deletion) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">₪</span>
                                            <input id="partial_payment_value" type="number" step="0.01" class="form-control @error('partial_payment_value') is-invalid @enderror" name="partial_payment_value" value="{{ old('partial_payment_value', $workOrder->partial_payment_value) }}">
                                        </div>
                                ...
                                <div class="form-section mb-4">
                                    <h4 class="section-title mb-3">معلومات التواريخ</h4>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="approval_date" class="form-label fw-bold">تاريخ الاعتماد</label>
                                                <input id="approval_date" type="date" class="form-control @error('approval_date') is-invalid @enderror" name="approval_date" value="{{ old('approval_date', date('Y-m-d', strtotime($workOrder->approval_date))) }}">
                                                @error('approval_date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input id="procedure_155_delivery_date" type="date" class="form-control @error('procedure_155_delivery_date') is-invalid @enderror" name="procedure_155_delivery_date" value="{{ old('procedure_155_delivery_date', $workOrder->procedure_155_delivery_date ? $workOrder->procedure_155_delivery_date->format('Y-m-d') : '') }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input id="procedure_211_date" type="date" class="form-control @error('procedure_211_date') is-invalid @enderror" name="procedure_211_date" value="{{ old('procedure_211_date', $workOrder->procedure_211_date ? $workOrder->procedure_211_date->format('Y-m-d') : '') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input id="extract_number" type="text" class="form-control @error('extract_number') is-invalid @enderror" name="extract_number" value="{{ old('extract_number', $workOrder->extract_number) }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input id="extract_date" type="date" class="form-control @error('extract_date') is-invalid @enderror" name="extract_date" value="{{ old('extract_date', $workOrder->extract_date ? $workOrder->extract_date->format('Y-m-d') : '') }}">
                                                @error('extract_date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text">₪</span>
                                                    <input id="extract_value" type="number" step="0.01" class="form-control @error('extract_value') is-invalid @enderror" name="extract_value" value="{{ old('extract_value', $workOrder->extract_value) }}">
                                                </div>
                                                @error('extract_value')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input id="invoice_number" type="text" class="form-control @error('invoice_number') is-invalid @enderror" name="invoice_number" value="{{ old('invoice_number', $workOrder->invoice_number) }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input id="purchase_order_number" type="text" class="form-control @error('purchase_order_number') is-invalid @enderror" name="purchase_order_number" value="{{ old('purchase_order_number', $workOrder->purchase_order_number) }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text">₪</span>
                                                    <input id="tax_value" type="number" step="0.01" class="form-control @error('tax_value') is-invalid @enderror" name="tax_value" value="{{ old('tax_value', $workOrder->tax_value) }}">
                                                </div>
                                                @error('tax_value')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="form-section mb-4">
                                    <h4 class="section-title mb-3">الملاحظات</h4>
                                    <div class="form-group mb-3">
                                        <label for="notes" class="form-label fw-bold">ملاحظات</label>
                                        <textarea id="notes" class="form-control @error('notes') is-invalid @enderror" name="notes" rows="4" placeholder="أدخل أي ملاحظات إضافية هنا...">{{ old('notes', $workOrder->notes) }}</textarea>
                                        @error('notes')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
