    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function calculateWithoutConsultant() {
            ...
            if (!isNaN(valueWithConsultant) && valueWithConsultant > 0) {
                ...
                const valueWithoutConsultant = valueWithConsultant / 1.12; // 100% - 12% = 88%
