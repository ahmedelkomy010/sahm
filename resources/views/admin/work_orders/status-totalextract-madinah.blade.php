    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #00bcd4 0%, #00acc1 100%);">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="mb-1">
                                <i class="fas fa-file-contract me-2"></i>
                                تم إعداد المستخلص الكلي وجاري الصرف (المدينة المنورة)
                            </h3>
                            <p class="mb-0 opacity-90">
                                <i class="fas fa-mosque me-1"></i>
                                عرض جميع أوامر العمل بالمدينة المنورة التي حالتها: تم إعداد المستخلص الكلي وجاري الصرف
                            </p>
                        </div>
                        <div>
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="card shadow-sm border-0" style="background: linear-gradient(135deg, #00bcd4 0%, #00acc1 100%);">
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm border-0" style="background: linear-gradient(135deg, #0097a7 0%, #00838f 100%);">
                        <div class="card-body text-white text-center">
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.work-orders.status.totalextract.madinah') }}" class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{ route('admin.work-orders.status.export-totalextract', ['project' => 'madinah']) }}" 
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge" style="background-color: #00bcd4;">
                    ...
                    <div class="alert alert-info text-center">
                        ...
                        <p class="mb-0">لا توجد أوامر عمل بحالة "تم إعداد المستخلص الكلي وجاري الصرف" في المدينة المنورة حالياً</p>
                    </div>
                    @endif
                </div>
            </div>
