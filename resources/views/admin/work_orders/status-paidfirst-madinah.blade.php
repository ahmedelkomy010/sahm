    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header text-white py-3" style="background: linear-gradient(135deg, #ff9800 0%, #ffb74d 100%);">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="mb-1">
                                <i class="fas fa-money-check-alt me-2"></i>
                                تم صرف مستخلص الدفعة الجزئية الأولى (المدينة المنورة)
                            </h3>
                            <p class="mb-0 opacity-90">
                                <i class="fas fa-mosque me-1"></i>
                                عرض جميع أوامر العمل بالمدينة المنورة التي حالتها: تم صرف مستخلص الدفعة الجزئية الأولى
                            </p>
                        </div>
                        <div>
            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="card shadow-sm border-0" style="background: linear-gradient(135deg, #ff9800 0%, #ffb74d 100%);">
                        <div class="card-body text-white text-center">
                            <i class="fas fa-check-double fa-3x mb-3 opacity-75"></i>
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.work-orders.status.paidfirst.madinah') }}" class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{ route('admin.work-orders.status.export-paidfirst', ['project' => 'madinah']) }}" 
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge" style="background-color: #ff9800;">
                                            ...
                                            تم صرف مستخلص الدفعة الجزئية الأولى
                                        </span>
                                    </td>
                                    <td class="text-center">
                    ...
                    <div class="alert alert-info text-center">
                        ...
                        <p class="mb-0">لا توجد أوامر عمل بحالة "تم صرف مستخلص الدفعة الجزئية الأولى" في المدينة المنورة حالياً</p>
                    </div>
                    @endif
                </div>
            </div>
