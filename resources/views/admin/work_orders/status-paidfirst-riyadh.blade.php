    ...
    <div class="row">
        <div class="col-12">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="mb-1">
                                ...
                                تم صرف مستخلص الدفعة الجزئية الأولى (الرياض)
                            </h3>
                            <p class="mb-0 opacity-90">
                                <i class="fas fa-city me-1"></i>
                                عرض جميع أوامر العمل بالرياض التي حالتها: تم صرف مستخلص الدفعة الجزئية الأولى
                            </p>
                        </div>
                        <div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.work-orders.status.paidfirst.riyadh') }}" class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{ route('admin.work-orders.status.export-paidfirst', ['project' => 'riyadh']) }}" 
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info text-center">
                        ...
                        <p class="mb-0">لا توجد أوامر عمل بحالة "تم صرف مستخلص الدفعة الجزئية الأولى" في الرياض حالياً</p>
                    </div>
                    @endif
                </div>
            </div>
