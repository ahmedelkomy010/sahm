        ...
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-1">
                                    ...
                                    أوامر العمل المتأخرة (المدينة المنورة)
                                </h3>
                                <p class="mb-0 opacity-90">
                                    <i class="fas fa-mosque me-1"></i>
                                    عرض أوامر العمل التي تجاوزت المدة الزمنية المحددة في مشروع المدينة المنورة
                                </p>
                            </div>
                            <div>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.time-management.overdue.madinah') }}" class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                ...
                                <a href="{{ route('admin.time-management.overdue.madinah') }}" class="btn btn-secondary ms-2">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-light">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.time-management.export-overdue', ['project' => 'madinah']) }}?days={{ $days ?? 0 }}" 
