        ...
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h3 class="mb-1">
                                    ...
                                    التقرير اوامر العمل التي عليها معوقات تنفيذ - المدينة المنورة
                                </h3>
                                <p class="mb-0 opacity-90">
                                    <i class="fas fa-mosque me-1"></i>
                                    نظرة شاملة على أوامر العمل والمعوقات في مشروع المدينة المنورة
                                </p>
                            </div>
                            <div>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.time-management.detailed-report.madinah') }}">
                            <div class="row g-3">
                                <!-- Search Field -->
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{ route('admin.time-management.detailed-report.madinah') }}" 
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('admin.time-management.export-obstacles', ['project' => 'madinah']) }}" 
