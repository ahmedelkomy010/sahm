                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" id="riyadh_manage_safety" name="permissions[]" value="riyadh_manage_safety" 
                                            {{ (is_array(old('permissions')) && in_array('riyadh_manage_safety', old('permissions'))) ? 'checked' : '' }}
                                            class="h-3 w-3 ml-1 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
        ...
        <div class="bg-gradient-to-br from-teal-50 to-cyan-50 p-4 rounded-lg mb-6 border-2 border-teal-200">
            <div class="flex items-start">
                <input type="checkbox" id="access_total_project_revenues" name="permissions[]" value="access_total_project_revenues" 
                    {{ (is_array(old('permissions')) && in_array('access_total_project_revenues', old('permissions'))) ? 'checked' : '' }}
