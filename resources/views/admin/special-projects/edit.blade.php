                ...
                <div class="mb-4 p-4 bg-purple-50 rounded-xl">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="srgn_date" class="form-label text-right d-block">تاريخ التوقيع (SIGN)</label>
                            <input type="date" 
                                   class="form-control" 
                                   id="srgn_date" 
                                   name="srgn_date" 
                        ...
                        <!-- FAT Date -->
                        <div class="col-md-6 mb-3">
                            <label for="fat_date" class="form-label text-right d-block">تاريخ FAC</label>
                            <input type="date" 
                                   class="form-control" 
                                   id="fat_date" 
                                   name="fat_date" 
