        ...
        <div class="header-gradient rounded-3xl shadow-2xl overflow-hidden mb-12 relative">
            <div class="relative z-10 p-8 text-center text-white">
                <div class="mb-6">
                    ...
                    @if($description)
                    <p class="text-pink-100 text-lg mt-3">{{ $description }}</p>
                    @endif
                    <p class="text-pink-100 text-sm mt-2">{{ $project->name }} - Clarification</p>
                </div>

                <div class="max-w-md mx-auto">
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                        <p class="text-pink-100 text-sm mb-1">Files in this folder</p>
