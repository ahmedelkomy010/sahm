            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 border-2 border-gray-100">
                        ...
                        <form action="{{ route('projects.documents.create-folder', $project) }}" method="POST" class="space-y-4">
                            @csrf
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       name="folder_name" 
                                       required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-gray-500 text-right"
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 border-2 border-blue-100">
                        ...
                        <form action="{{ route('projects.documents.upload-files', $project) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                            @csrf
                            <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-white border-2 border-gray-100 rounded-xl p-4 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
                            <div class="flex items-start mb-3">
                                <div class="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center ml-3 flex-shrink-0">
                            ...
                            <div class="flex items-center gap-2 mt-3">
                                <a href="{{ route('projects.documents.folder', ['project' => $project, 'folderName' => $folder['name']]) }}" class="flex-1 px-3 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg text-sm transition-colors text-center">
