...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="header-gradient rounded-3xl shadow-2xl overflow-hidden mb-12 relative">
            <div class="relative z-10 p-8 text-center text-white">
                <div class="mb-6">
                    ...
                    <h1 class="text-4xl font-bold mb-3">Tech Files</h1>
        ...
        <!-- Create Folder & Upload Tech Files -->
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
            <div class="p-8">
                <h2 class="text-xl font-bold text-green-900 mb-6 text-left">Folders & Files Management</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-gradient-to-br from-green-50 to-white rounded-xl p-6 border-2 border-green-100">
                        ...
                        <form action="{{ route('projects.study.tech-files.create-folder', $project) }}" method="POST" class="space-y-4">
                            @csrf
                            <div>
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 border-2 border-blue-100">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-lg font-semibold text-green-900">Upload Multiple Files</h3>
                        </div>
                        
                        <form action="{{ route('projects.study.tech-files.upload-files', $project) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                            @csrf
                            <div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="p-8">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-bold text-green-900">Folders & Files</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white border-2 border-green-100 rounded-xl p-4 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
                            ...
                            <div class="flex items-center gap-2 mt-3">
                                <a href="{{ route('projects.study.tech-files.folder', ['project' => $project, 'folderName' => $folder['name']]) }}" class="flex-1 px-3 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg text-sm transition-colors text-center">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-semibold text-green-900 mb-2">No Folders or Files

                        <p class="text-green-600"> Start by creating a new folder or uploading files
                    </div>
                @endif
            </div>
        </div>
