    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex justify-end">
            <a href="{{ route('projects.study', $project) }}" 
               class="inline-flex items-center px-6 py-3 bg-white/80 backdrop-blur-sm border border-purple-200 text-purple-700 rounded-xl font-semibold shadow-lg hover:bg-white hover:shadow-xl transition-all duration-300 hover:transform hover:scale-105">
        ...
        <div class="header-gradient rounded-3xl shadow-2xl overflow-hidden mb-12 relative">
            <div class="relative z-10 p-8 text-center text-white">
                <div class="mb-6">
                    ...
                    <h1 class="text-4xl font-bold mb-3">Sch C</h1>
        ...
        <!-- Create Folder & Upload Sch C -->
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
            <div class="p-8">
                <h2 class="text-xl font-bold text-purple-900 mb-6 text-left">Folders & Files Management</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-white rounded-xl p-6 border-2 border-purple-100">
                        ...
                        <form action="{{ route('projects.study.sch-c.create-folder', $project) }}" method="POST" class="space-y-4">
                            @csrf
                            <div>
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 border-2 border-blue-100">
                        ...
                        <form action="{{ route('projects.study.sch-c.upload-files', $project) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                            @csrf
                            <div>
                                <label for="folder_id" class="block text-sm font-medium text-purple-700 mb-2 text-left">Select Folder</label>
                                <select id="folder_id" 
                                        name="folder_id" 
                                        class="w-full px-4 py-3 border border-purple-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-left">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <label for="files" 
                                           class="flex items-center justify-center w-full px-4 py-8 border-2 border-dashed border-purple-300 rounded-lg cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-all">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="p-8">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-bold text-purple-900">Folders & Files</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-white border-2 border-purple-100 rounded-xl p-4 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
                            ...
                            <div class="flex items-center gap-2 mt-3">
                                <a href="{{ route('projects.study.sch-c.folder', ['project' => $project, 'folderName' => $folder['name']]) }}" class="flex-1 px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm transition-colors text-center">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-semibold text-purple-900 mb-2">No Folders or Files

                        <p class="text-purple-600"> Start by creating a new folder or uploading files
                    </div>
                @endif
            </div>
        </div>
    ...
    if (input.files.length > 0) {
        ...
        summary.innerHTML = `
            <p class="text-sm text-blue-700 font-medium text-left">
                تم اختيار ${input.files.length} ${input.files.length === 1 ? 'Files'Folders 
            </p>
        `;
