...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-12">
    <div class="container-fluid mx-auto px-4 sm:px-6 lg:px-8" style="max-width: 95%;">
        ...
        <div class="header-gradient rounded-3xl shadow-2xl overflow-hidden mb-12 relative">
            <div class="relative z-10 p-8 text-center text-white">
                <div class="mb-6">
                    ...
                    <h1 class="text-4xl font-bold mb-3">CLA2</h1>
                    <p class="text-blue-100 text-lg">{{ $project->name }}</p>
                    <p class="text-blue-100 text-sm mt-2">Contract: {{ $project->contract_number }}</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
            <div class="p-8">
                <h2 class="text-xl font-bold text-blue-900 mb-6 text-left">Folders and Attachments Management</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-6 border-2 border-blue-100">
                        ...
                        <form action="{{ route('projects.clarification.cla2.create-folder', $project) }}" method="POST" class="space-y-4">
                            @csrf
                            <div>
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 to-white rounded-xl p-6 border-2 border-indigo-100">
                        <div class="flex items-center mb-4">
                            ...
                            <h3 class="text-lg font-semibold text-blue-900">Upload Multiple Attachments</h3>
                        </div>
                        
                        <form action="{{ route('projects.clarification.cla2.upload-files', $project) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                            @csrf
                            <div>
                                <label for="folder_id" class="block text-sm font-medium text-blue-700 mb-2 text-left">Select Folder</label>
                                <select id="folder_id" 
                                        name="folder_id" 
                                        class="w-full px-4 py-3 border border-blue-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-left">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <label for="files" 
                                           class="flex items-center justify-center w-full px-4 py-8 border-2 border-dashed border-blue-300 rounded-lg cursor-pointer hover:border-indigo-500 hover:bg-indigo-50 transition-all">
                            ...
                            <button type="submit" 
                                    class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-6 rounded-lg shadow-sm transition duration-150 ease-in-out flex items-center justify-center">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="p-8">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-bold text-blue-900 text-left">Folders and Files</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-white border-2 border-blue-100 rounded-xl p-4 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
                            ...
                            <div class="flex items-center gap-2 mt-3">
                                <a href="{{ route('projects.clarification.cla2.folder', ['project' => $project, 'folderName' => $folder['name']]) }}" class="flex-1 px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm transition-colors text-center">
                        ...
                        <div class="bg-gradient-to-br from-indigo-50 to-white border-2 border-indigo-100 rounded-xl p-4 hover:shadow-lg transition-all duration-300 hover:scale-105">
                            <div class="flex items-start mb-3">
                                <div class="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center mr-3 flex-shrink-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-blue-500 text-left">{{ number_format($file['size'] / 1024, 2) }} KB</p>
                                </div>
                            </div>
                            
                            <div class="flex items-center justify-between text-xs pt-3 border-t border-indigo-100">
...
function updateFileList(input) {
    ...
    if (input.files.length > 0) {
        ...
        summary.className = 'mt-3 p-3 bg-indigo-50 rounded-lg border border-indigo-200';
        summary.innerHTML = `
            <p class="text-sm text-indigo-700 font-medium text-left">
                ${input.files.length} ${input.files.length === 1 ? 'file' : 'files'} selected
            </p>
        `;
