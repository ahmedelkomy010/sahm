        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="p-8">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-bold text-purple-900">Files in this Folder</h2>
                    <span class="text-sm text-purple-500">{{ count($files) }} Files</span>
                </div>
                ...
                @if(count($files) > 0)
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-white border-2 border-purple-100 rounded-xl p-4 hover:shadow-lg transition-all duration-300 hover:scale-105">
                            ...
                            <div class="flex items-center justify-between text-xs pt-3 border-t border-purple-100 mb-3">
                                <span class="text-purple-400">{{ $file['created_at'] }}</span>
                                <span class="text-purple-500 uppercase font-semibold">{{ $file['extension'] }}</span>
                            </div>
                            ...
                            <div class="flex gap-2">
                                ...
                                <a href="{{ $file['url'] }}" download class="flex-1 px-3 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg text-sm transition-colors text-center">
                                    <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-semibold text-purple-900 mb-2">No Files</h3>
                        <p class="text-purple-600">This folder is empty</p>
                    </div>
                @endif
            </div>
        </div>
