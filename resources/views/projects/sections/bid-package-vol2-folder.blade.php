...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-100 py-12" dir="ltr">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex justify-start">
            <a href="{{ route('projects.bid-package.vol2', $project) }}" 
        ...
        <div class="header-gradient rounded-3xl shadow-2xl overflow-hidden mb-12 relative">
            <div class="relative z-10 p-8 text-center text-white">
                <div class="mb-6">
                    ...
                    @if($description)
                    <p class="text-purple-100 text-lg mt-3">{{ $description }}</p>
                    @endif
                    <p class="text-purple-100 text-sm mt-2">{{ $project->name }} - Bid Package Vol 2</p>
                </div>

                <div class="max-w-md mx-auto">
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                        <p class="text-purple-100 text-sm mb-1">Files in this folder</p>
            ...
            <div class="p-8">
                ...
                @if(count($files) > 0)
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-white border-2 border-purple-100 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
                            <div class="flex items-start mb-4">
                                <div class="w-14 h-14 bg-purple-100 rounded-xl flex items-center justify-center ml-3 flex-shrink-0">
                            ...
                            <div class="flex items-center gap-2 mt-4 pt-4 border-t border-purple-100">
                                <a href="{{ $file['url'] }}" target="_blank" class="flex-1 px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm transition-colors text-center">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">لا توجد ملفات</h3>
                        <p class="text-gray-600">المجلد فارغ حالياً</p>
                    </div>
                @endif
            </div>
        </div>
