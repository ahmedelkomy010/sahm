...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-emerald-100 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="header-gradient rounded-3xl shadow-2xl overflow-hidden mb-12 relative">
            <div class="relative z-10 p-8 text-center text-white">
                <div class="mb-6">
                    ...
                    <h1 class="text-4xl font-bold mb-3">Supplying Management</h1>
                    <p class="text-green-100 text-lg">{{ $project->name }} - Contract: {{ $project->contract_number }}</p>
                </div>
            </div>
        </div>

        <!-- Supply Documents Grid -->
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-12">
            
            <!-- PO (Purchase Order) -->
            <div class="supply-card rounded-2xl p-8" style="--card-color: #3b82f6;">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-900 mb-1">PO (Purchase Order)</h3>
                        <p class="text-gray-600 text-sm">Purchase orders & procurement documents</p>
                    </div>
                </div>
                
                <!-- Upload Zone -->
                <div class="upload-zone rounded-xl p-6 mb-6 text-center">
                    <input type="file" id="po-files" class="hidden" multiple accept=".pdf,.xlsx,.xls,.doc,.docx">
                    <label for="po-files" class="cursor-pointer">
                ...
                <!-- File List -->
                <div class="space-y-3" id="po-files-list">
                    <div class="file-item rounded-lg p-3 flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="font-medium text-gray-900 text-sm">Purchase_Order_001.pdf</p>
                                <p class="text-gray-500 text-xs">1.8 MB • 3 days ago</p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <button class="text-blue-600 hover:text-blue-800 p-1" title="View">
            ...
            <!-- Commercial -->
            <div class="supply-card rounded-2xl p-8" style="--card-color: #10b981;">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-900 mb-1">Commercial</h3>
                        <p class="text-gray-600 text-sm">Commercial agreements & contracts</p>
                    </div>
                </div>
                
                <!-- Upload Zone -->
                <div class="upload-zone rounded-xl p-6 mb-6 text-center">
                    <input type="file" id="commercial-files" class="hidden" multiple accept=".pdf,.xlsx,.xls,.doc,.docx">
                    <label for="commercial-files" class="cursor-pointer">
                        <svg class="w-12 h-12 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
                        </svg>
                        <p class="text-gray-600 font-medium">Drop files here or click to upload</p>
                ...
                <!-- File List -->
                <div class="space-y-3" id="commercial-files-list">
                    <div class="file-item rounded-lg p-3 flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="font-medium text-gray-900 text-sm">Commercial_Agreement.xlsx</p>
                                <p class="text-gray-500 text-xs">2.1 MB • 1 week ago</p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <button class="text-blue-600 hover:text-blue-800 p-1" title="View">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-12">
            ...
            <div class="supply-card rounded-2xl p-8" style="--card-color: #f59e0b;">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-900 mb-1">FAT (Factory Acceptance Test)</h3>
                        <p class="text-gray-600 text-sm">Factory testing & acceptance documents</p>
                    </div>
                </div>
                
                <!-- Upload Zone -->
                <div class="upload-zone rounded-xl p-6 mb-6 text-center">
                    <input type="file" id="fat-files" class="hidden" multiple accept=".pdf,.xlsx,.xls,.doc,.docx">
                    <label for="fat-files" class="cursor-pointer">
                        <svg class="w-12 h-12 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
                        </svg>
                        <p class="text-gray-600 font-medium">Drop files here or click to upload</p>
                ...
                <!-- File List -->
                <div class="space-y-3" id="fat-files-list">
                    <div class="file-item rounded-lg p-3 flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="font-medium text-gray-900 text-sm">FAT_Test_Report.pdf</p>
                                <p class="text-gray-500 text-xs">3.2 MB • 5 days ago</p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <button class="text-blue-600 hover:text-blue-800 p-1" title="View">
            ...
            <!-- Delivery -->
            <div class="supply-card rounded-2xl p-8" style="--card-color: #8b5cf6;">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-900 mb-1">Delivery</h3>
                        <p class="text-gray-600 text-sm">Delivery schedules & shipping documents</p>
                    </div>
                </div>
                
                <!-- Upload Zone -->
                <div class="upload-zone rounded-xl p-6 mb-6 text-center">
                    <input type="file" id="delivery-files" class="hidden" multiple accept=".pdf,.xlsx,.xls,.doc,.docx">
                    <label for="delivery-files" class="cursor-pointer">
                        <svg class="w-12 h-12 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
                        </svg>
                        <p class="text-gray-600 font-medium">Drop files here or click to upload</p>
                ...
                <!-- File List -->
                <div class="space-y-3" id="delivery-files-list">
                    <div class="file-item rounded-lg p-3 flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="font-medium text-gray-900 text-sm">Delivery_Schedule.xlsx</p>
                                <p class="text-gray-500 text-xs">1.5 MB • 2 days ago</p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <button class="text-blue-600 hover:text-blue-800 p-1" title="View">
        ...
        <div class="supply-card rounded-2xl p-8 mb-8" style="--card-color: #10b981;">
            <div class="text-center mb-8">
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Supply Progress Overview</h2>
                <p class="text-gray-600">Track the progress of different supply phases</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">PO Processing</h3>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">FAT Testing</h3>
            ...
            <!-- Overall Progress -->
            <div class="text-center">
                <h4 class="text-lg font-semibold text-gray-900 mb-4">Overall Supply Progress</h4>
                <div class="text-4xl font-bold text-emerald-600 mb-4">54%</div>
                <div class="w-full bg-gray-200 rounded-full h-4 max-w-md mx-auto">
                    <div class="bg-gradient-to-r from-green-500 to-emerald-600 h-4 rounded-full" style="width: 54%"></div>
                </div>
            </div>
        </div>
...
<script>
// File upload functionality for supplying
document.addEventListener('DOMContentLoaded', function() {
    ...
    const fileInputs = ['po-files', 'commercial-files', 'fat-files', 'delivery-files'];
    ...
    function handleFiles(files, inputId) {
        ...
        Array.from(files).forEach(file => {
            ...
            if (isValidFile(file)) {
                ...
                showNotification('Invalid file type: ' + file.name + '. Please upload PDF, Excel, or Word files.', 'error');
                return;
            }
        });
        ...
        // Upload files
        fetch(`/projects/${projectId}/supplying/upload`, {
            method: 'POST',
            body: formData,
            headers: {
    ...
    function loadFiles(section, inputId) {
        fetch(`/projects/${projectId}/supplying/${section}/files`)
...
function deleteFile(button, section, filename) {
    if (confirm('Are you sure you want to delete this file?')) {
        ...
        fetch(`/projects/${projectId}/supplying/${section}/${filename}`, {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': csrfToken,
