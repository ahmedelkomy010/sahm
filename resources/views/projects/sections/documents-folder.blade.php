...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex justify-end">
            <a href="{{ route('projects.documents', $project) }}" 
        ...
        <div class="header-gradient rounded-3xl shadow-2xl overflow-hidden mb-12 relative">
            <div class="relative z-10 p-8 text-center text-white">
                <div class="mb-6">
                    ...
                    @if($description)
                    <p class="text-gray-100 text-lg mt-3">{{ $description }}</p>
                    @endif
                    <p class="text-gray-100 text-sm mt-2">{{ $project->name }} - Documents</p>
                </div>

                <div class="max-w-md mx-auto">
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                        <p class="text-gray-100 text-sm mb-1">Files in this folder</p>
