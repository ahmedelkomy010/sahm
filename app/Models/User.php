...
class User extends Authenticatable
{
    ...
    const PERMISSIONS = [
        ...
        'riyadh_manage_revenues' => 'إدارة الإيرادات - الرياض',
        'riyadh_create_work_order' => 'إنشاء أمر عمل - الرياض',
        'riyadh_edit_work_order' => 'تعديل أمر عمل - الرياض',
        'riyadh_export_excel' => 'تصدير إكسل - الرياض',
        'riyadh_view_revenues' => 'عرض الإيرادات - الرياض',
        ...
        'madinah_manage_revenues' => 'إدارة الإيرادات - المدينة المنورة',
        'madinah_create_work_order' => 'إنشاء أمر عمل - المدينة المنورة',
        'madinah_edit_work_order' => 'تعديل أمر عمل - المدينة المنورة',
        'madinah_export_excel' => 'تصدير إكسل - المدينة المنورة',
        'madinah_view_revenues' => 'عرض الإيرادات - المدينة المنورة',
